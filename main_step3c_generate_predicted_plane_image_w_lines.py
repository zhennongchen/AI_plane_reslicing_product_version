...
for i in range(0,len(patient_list)):
    ...
    if seg_batch == 'x' and threec_batch == 'x':
        ...
        save_folder = os.path.join(cg.final_dir,patient_class,patient_id,'planes_pred_lines')
    ...
    if os.path.isfile(os.path.join(cg.final_dir,patient_class,patient_id,'planes_pred_lines',patient_id+'_predicted_planes.mp4')) == 1:
        print('already done')
    else:
